from tktkt.util.printing import PrintTable
...
def test_morphsplits():
    ...
    for lemma, morphemes in examples:
        ...
        print(alignMorphemes_Greedy(lemma, morphemes.split(" ")))
        print(alignMorphemes_Viterbi(lemma, morphemes.split(" ")))
        print()
...
def test_all():
    table = PrintTable()
    data = Dutch_Celex()
    for o in data.generate():
        # if " " in o.lexemeSplit():
        # if not o.isNNC():
        table.print(o.word, "L: " + "/".join(o.segmentFree()), "M: " + "/".join(o.segment()), "M'eme: " + "/".join(o.decompose()))
...
def test_german():
    ...
    for l, m in examples:
        ...
        o.printAlignments()
        print("Morph:", o.segment())
        print("  Lex:", o.segmentFree())
        print()
